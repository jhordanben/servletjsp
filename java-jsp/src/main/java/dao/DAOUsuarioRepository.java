...
public class DAOUsuarioRepository {
	...
	public ModelLogin gravarUsuario(ModelLogin objeto, Long userLogado) throws Exception {
		...
		if (objeto.isNovo()) {
			...
			String sql = "INSERT INTO loginmodel(login, senha, nome, email, usuario_id, perfil, sexo, cep, logradouro, bairro, localidade, uf, numero, datanascimento) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
			...
			if (objeto.getFotouser() != null && !objeto.getFotouser().isEmpty()) {
				sql = "update loginmodel set fotouser = ?, extensaofotouser = ? where login = ?";
			...
			String sql = "UPDATE loginmodel SET login=?, senha=?, nome=?, email=?, perfil=?, sexo=?, cep=?, logradouro=?, bairro=?, localidade=?, uf=?, numero=?, datanascimento=? WHERE id = "+ objeto.getId() + ";";
			...
			if (objeto.getFotouser() != null && !objeto.getFotouser().isEmpty()) {
				sql = "update loginmodel set fotouser = ?, extensaofotouser = ? where id = ?";
	...
	String sql = "select count(1) as total from loginmodel where upper(nome) like upper(?) and useradmin is false and usuario_id = ? limit 5";
	...
	public List<ModelLogin> consultaUsuarioListOffSet(String nome, Long userLogado, int offset) throws Exception {
		...
		String sql = "select * from loginmodel where upper(nome) like upper(?) and useradmin is false and usuario_id = ? offset "+offset+" limit 5";
	...
	public List<ModelLogin> consultaUsuarioList(String nome, Long userLogado) throws Exception {
		...
		String sql = "select * from loginmodel where upper(nome) like upper(?) and useradmin is false and usuario_id = ? limit 5";
	...
	public int totalPagina (Long userLogado) throws Exception {
		...
		String sql = "select count(1) as total from loginmodel where usuario_id = " + userLogado;
		PreparedStatement statement = connection.prepareStatement(sql);
	...
	public List<ModelLogin> consultaUsuarioListPaginada(Long userLogado, Integer offset) throws Exception {
		...
		String sql = "select * from loginmodel where useradmin is false and usuario_id = " + userLogado + " order by nome offset "+offset+" limit 5";
	...
	public List<ModelLogin> consultaUsuarioList(Long userLogado) throws Exception {
		...
		String sql = "select * from loginmodel where useradmin is false and usuario_id = " + userLogado + " limit 5";
	...
	public ModelLogin consultaUsuario(String login) throws Exception {
		...
		String sql = "select * from loginmodel where upper(login) = upper('" + login + "') and useradmin is false";
	...
	public boolean validarLogin(String login) throws Exception {
		...
		resultado.next(); // tem que dar um next pra ele entrar nos resultados do sql
